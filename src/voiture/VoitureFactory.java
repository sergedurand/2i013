...
public class VoitureFactory {
	  ...
	  private final static double alpha_c = 0.005;
	  private final static double braquage = 0.1;
	  private final static double alpha_f = 0.0002;
	  private final static double beta_f = 0.0005;
